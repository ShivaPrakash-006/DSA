...
void insert(Student *arr, int *n)
{
  ...
  Student student;
  printf("Roll No: "); scanf("%i", &student.roll); getchar();
  ...
  printf("Age: "); scanf("%i", &student.age); getchar();
  printf("Gender (M/F): "); student.gender = getchar();
  if (student.gender != 'M' && student.gender != 'F')
    return;
  printf("Mark1 (0-100): "); scanf("%i", &student.mark1);
  printf("Mark2 (0-100): "); scanf("%i", &student.mark2);
  printf("Mark3 (0-100): "); scanf("%i", &student.mark3);
...
void delete(Student *arr, int *n)
{
  ...
  found = 0;
  printf("Roll No: "); scanf("%i", &keyRoll);
  for (int i = 0; i < *n; i++)
    ...
    switch (choice){
      case 1:
        ...
        switch (choice){
          ...
          case 2:
            printf("Enter Roll No: "); scanf("%i", &roll);
